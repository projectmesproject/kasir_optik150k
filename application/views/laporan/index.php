                      ...
                      <th>Aksi</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <a class="btn btn-sm btn-success"
                                            href="<?php echo site_url('laporan/lap_data_barang')?>"
                                            ><span class="fa fa-print"></span> View</a>
                                        <a class="btn btn-sm btn-success"
                                            href="<?php echo site_url('laporan/lap_data_barang_cetak')?>"
                                            target="_blank"><span class="fa fa-print"></span> Print</a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <a class="btn btn-sm btn-success"
                                            href="<?php echo site_url('laporan/lap_stok_barang')?>"
                                            ><span class="fa fa-print"></span> View</a>
                                        <a class="btn btn-sm btn-success"
                                            href="<?php echo site_url('laporan/lap_stok_barang_cetak')?>"
                                            target="_blank"><span class="fa fa-print"></span> Print</a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <a class="btn btn-sm btn-success"
                                            href="<?php echo site_url('laporan/lap_data_penjualan')?>"
                                            ><span class="fa fa-print"></span> View</a>
                                        <a class="btn btn-sm btn-success"
                                            href="<?php echo site_url('laporan/lap_data_penjualan_cetak')?>"
                                            target="_blank"><span class="fa fa-print"></span> Print</a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <a class="btn btn-sm btn-success" href="#lap_jual_periode" data-toggle="modal"><span
                                                class="fa fa-print"></span> View</a>
                                        <a class="btn btn-sm btn-success" href="#lap_jual_periode_cetak"
                                            data-toggle="modal"><span class="fa fa-print"></span> Print</a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <a class="btn btn-sm btn-success" href="#lap_jual_barang" data-toggle="modal"><span
                                                class="fa fa-print"></span> View</a>
                                        <a class="btn btn-sm btn-success" href="#lap_jual_barang_cetak"
                                            data-toggle="modal"><span class="fa fa-print"></span> Print</a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <a class="btn btn-sm btn-success" href="#lap_penjualan_kat_barang" data-toggle="modal"><span
                                                class="fa fa-print"></span> View</a>
                                        <a class="btn btn-sm btn-success" href="#lap_penjualan_kat_barang_cetak"
                                            data-toggle="modal"><span class="fa fa-print"></span> Print</a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <a class="btn btn-sm btn-success" href="#lap_laba_rugi" data-toggle="modal"><span
                                                class="fa fa-print"></span> View</a>
                                        <a class="btn btn-sm btn-success" href="#lap_laba_rugi_cetak"
                                            data-toggle="modal"><span class="fa fa-print"></span> Print</a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <a class="btn btn-sm btn-success" href="#lap_pengeluaran_toko" data-toggle="modal"><span
                                                class="fa fa-print"></span> View</a>
                                        <a class="btn btn-sm btn-success" href="#lap_pengeluaran_toko_cetak"
                                            data-toggle="modal"><span class="fa fa-print"></span> Print</a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;">
										<a class="btn btn-sm btn-success"
										   href="<?php echo site_url('laporan/lap_hutang_karyawan')?>"><span
                                                class="fa fa-print"></span> View</a>
                                        <a class="btn btn-sm btn-success"
                                            href="<?php echo site_url('laporan/lap_hutang_karyawan_cetak')?>" target="_blank"><span
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <a class="btn btn-sm btn-success" href="#lap_resume" data-toggle="modal"><span
                                                class="fa fa-print"></span> View</a>
                                        <a class="btn btn-sm btn-success" href="#lap_resume_cetak" data-toggle="modal"><span
                                                class="fa fa-print"></span> Print</a>
                                    </td>
                                </tr>
                            </tbody>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								<input type="date" class="form-control" name="tgl1" value="" placeholder="Tanggal"
									   required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								<input type="date" class="form-control" name="tgl2" value="" placeholder="Tanggal"
									   required>
							</div>
						</div>
