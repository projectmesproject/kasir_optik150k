                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <th><?php echo $v["d_jual_barang_id"];?></th>
                      ...
                      ?>
                      <th style="text-align:center;"><a href="<?php base_url()?>/../../penjualan_edit/remove_from_edit/<?=$v['d_jual_id'];?>?kd=<?php echo $this->uri->segment(3);?>" class="btn btn-warning btn-xs"><span class="fa fa-close"></span> Delete</a></th>
                    </tr>
                    <?php } ?>
...
<br>
                ...
                <tr>
                    <th>Tunai(Rp) :</th>
                    <th style="text-align:right;"><input type="text" id="jml_uang2" name="jml_uang2" class="jml_uang form-control input-sm" style="text-align:right;margin-bottom:5px;" required></th>
