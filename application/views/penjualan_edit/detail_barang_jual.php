...
<tr>
	...
	<td><input type="text" id="harjul" name="harjul" value="<?php echo number_format($b['barang_harga_cabang']); ?>" style="width:120px;margin-right:5px;text-align:right;" class="form-control input-sm" readonly></td>
